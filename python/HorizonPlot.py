...
flare.HorizonPlot(label,0,[2],[10],[.3],file,[0.001,0.01,0.10],scaled=True,show_range=True)
flare.HorizonPlot(label,1,[2],[10],[.3],file,[0.001,0.003,0.01,0.03,0.10,0.30],scaled=True)
flare.HorizonPlot(label,1,[2],[10],[.3],file,[0.001,0.01,0.10],scaled=True,show_range=True)
#flare.HorizonPlot(label,2,[2],[10],[.3],file,[0.10,0.30,1.0,3.0,10.0,30.0,100.0],scaled=True)
flare.HorizonPlot(label,3,[2],[10],[.3],file,[0.003,0.01,0.03,0.10,0.30],scaled=True)
flare.HorizonPlot(label,3,[2],[10],[.3],file,[0.01,0.10,0.5],scaled=True,show_range=True)
...
flare.HorizonPlot(label,9,[2],[10],[.3],file,[0.0278,0.25,1.0,9.0,100.0],scaled=True)
flare.HorizonPlot(label,9,[2],[10],[.3],file,[0.0278,1.0,25.0],scaled=True,show_range=True)
