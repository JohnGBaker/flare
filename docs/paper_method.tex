...
%Our challenge will be to accurately complete the representation of instrumental signals including precession effects and the LISA instrumental response and precession effects without sacrificing the computational efficiency enabled by these fast waveform templates. \SM{[rewrite that]}
