...
\end{align}
\end{subequations}
where the function $G$ and its derivatives are evaluated at $(f, t_{f})$. Reaching $\epsilon \simeq 1$ will indicate a breakdown of the perturbative approach. \SM{[expand a bit]}
